...
object QuestionsDataSource {
    private val listQuestion: List<Question> = mutableListOf(
        Question(
            Category.POLITICS, "Cual es el presidente actual de Colombia",
            listOf<Option>(
        ...
        Question(
            Category.POLITICS, "Cual es el salario minimo legal vigente para el 2022",
            listOf<Option>(
        ...
        Question(
            Category.POLITICS, "Cuando son las elecciones presidenciales 2022",
            listOf<Option>(
        ...
        Question(
            Category.CULTURE, "Cuantos anos tiene la tierra",
            listOf<Option>(
        ...
        Question(
            Category.GEOGRAPHY, "Cuantos estados tienen los Estados Unidos",
            listOf<Option>(
